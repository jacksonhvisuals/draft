    ...
    return (
      <div className='viewContainer'>
        ...
        <DetailToolbar tyle={{zIndex: '34'}} />
          <EditorContainer titleUpdate={this.titleEditorUpdate} bodyUpdate={this.bodyEditorUpdate} noteTitleState={this.state.notes[0][0, "noteTitle"]} noteContentState={this.state.notes[0][0, "noteContent"]}/>
        </Col>
      </div>
    );
  }
