...
export default class ViewContainer extends Component {
  ...
  render() {
    return ( <
      ...
      <
      RandroidToolbar tyle = {
        {
          zIndex: '34'
        }
      }
      /> <
      Col className = 'listPane'
      xs = {
        12
      }
      sm = {
      ...
      <
      ListContainer notesCollection = {
        this.state.notes
      }
      noteClickHandler = {
        this.currentActiveNoteSelector
      }
      /> <
      FAB fabClickHandler = {
        this.createNewNote
      ...
      /> < /
      Col > <
      Col className = 'detailPane hidden-xs'
      xs = {
        0
      }
      sm = {
      ...
      <
      EditorContainer titleUpdate = {
        this.titleEditorUpdate
      }
      bodyUpdate = {
        this.bodyEditorUpdate
      }
      noteTitleState = {
        this.state.notes[this.selectNote(this.state.currentNoteId)]["noteTitle"]
      }
      noteContentState = {
        this.state.notes[this.selectNote(this.state.currentNoteId)]["noteContent"]
      }
      currentNoteId = {
